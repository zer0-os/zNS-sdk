...
export const zAuctionConfiguration = (
  ...
  if (network === "mainnet") {
    ...
    defaultSubgraphUri = "https://api.thegraph.com/subgraphs/name/zer0-os/zauction";
    ...
    defaultSubgraphUri = "https://api.thegraph.com/subgraphs/name/zer0-os/zauction-kovan";
  ...
  return {
    ...
    subgraphUri: defaultSubgraphUri,
    zAuctionAddress: defaultZAuctionAddress,
  ...
  // TODO place back the checks, removing temporarily for dApp team
  // if (
